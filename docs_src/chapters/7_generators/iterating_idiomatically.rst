...
advantage of the itertools module. Actually, the ``sequence()`` generator we
...
can run a ``for .. in ...`` loop over it, and it will work without any issues. However, iterable does not mean
